...
try:
    start = input("Masukkan gedung awal: ")
    end = input("Masukkan gedung tujuan: ")

    if start not in graph or end not in graph:
        print("Gedung tidak ditemukan dalam graph.")
    else:
        # Implementasi yang lebih kuat untuk menemukan jalur alternatif
